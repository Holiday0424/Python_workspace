...
import anyio
from demo_fastapi import params
from demo_fastapi._compat import (
    PYDANTIC_V2,
    ModelField,
    RequiredParam,
    Undefined,
...
from demo_fastapi._compat.shared import annotation_is_pydantic_v1
from demo_fastapi.background import BackgroundTasks
from demo_fastapi.concurrency import (
    asynccontextmanager,
    contextmanager_in_threadpool,
)
from demo_fastapi.dependencies.models import Dependant, SecurityRequirement
from demo_fastapi.exceptions import DependencyScopeError
from demo_fastapi.logger import logger
from demo_fastapi.security.base import SecurityBase
from demo_fastapi.security.oauth2 import OAuth2, SecurityScopes
from demo_fastapi.security.open_id_connect_url import OpenIdConnect
from demo_fastapi.types import DependencyCacheKey
from demo_fastapi.utils import create_model_field, get_path_param_names
...
def is_union_of_base_models(field_type: Any) -> bool:
    ...
    from demo_fastapi.types import UnionType

...
from demo_fastapi.datastructures import DefaultPlaceholder, DefaultType
...
def create_model_field(
    ...
    if (
        ...
        from demo_fastapi._compat import v1

        try:
            return v1.ModelField(**v1_kwargs)  # type: ignore[no-any-return]
        except RuntimeError:
            raise demo_fastapi.exceptions.FastAPIError(_invalid_args_message) from None
    elif PYDANTIC_V2:
...
def generate_operation_id_for_path(
    *, name: str, path: str, method: str
    ...
    warnings.warn(
        "demo_fastapi.utils.generate_operation_id_for_path() was deprecated, "
